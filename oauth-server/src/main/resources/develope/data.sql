...
INSERT INTO access_token ( id, token, scope, client_id, user_id, date_created, date_updated ) VALUES
  ( 1, 'TOKEN1', '11', 1,  1, '2050-12-25', '2050-12-25' ),
  ( 2, 'TOKEN2', '00', 2,  2, '2050-12-25', '2050-12-25' ),
  ( 3, '$2a$10$dEFh.Tw.s05K66oj0gOopObZePAyYRGuTCkBLN5dvrdfS4x2RxtHO', '11', 2, 2, '2050-12-25', '2050-12-25' );
-- Mzo6OlRPS0VO

INSERT INTO auth_code ( id, code, scope, client_id, user_id, date_created, date_updated ) VALUES
  ( 1, 'CODE1', '11', 1,  1, '2050-12-25', '2050-12-25' ),
  ( 2, 'CODE2', '00', 2,  2, '2050-12-25', '2050-12-25' ),
  ( 3, '$2a$10$BCU4w83RytKXMUswUcflw.nhZdAAq.lr4Mf873a0C6zXX/IclxTIC', '11', 3, 3, '2050-12-25', '2050-12-25' );
-- Mzo6OkNPREU=
