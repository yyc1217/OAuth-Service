...
INSERT INTO api_token ( id, token, client_id, date_created, last_updated, date_expired ) VALUES
  ( 1, 'TOKEN1', 1, '2050-12-25', '2050-12-25', '2100-12-25' ),
  ( 2, 'TOKEN2', 2, '2050-12-25', '2050-12-25', '2000-12-25' ),
  ( 3, '$2a$10$QIWTQ5g9A5EiQOOGHlRDm.C4GBjlStg/Fzgj9h3xfYBqtyxSxKWDq', 3, '2050-12-25', '2050-12-25', '2100-12-25' );
-- Mzo6OlRPS0VO
...
INSERT INTO access_token ( id, token, client_id, user_id, date_created, last_updated, date_expired ) VALUES
...
INSERT INTO authorization_code ( id, code, client_id, user_id, date_created, last_updated, date_expired ) VALUES
