...
public class ClientServiceImpl implements ClientService {
    ...
    @Override
    @Transactional
    public ClientEntity createClient( Client application ) {
    ...
    public ClientEntity updateClient( String id, Client client ) {
        return clientRepository.updateClient(
                overrideClientByApplication( readClientByID( id ), client )
        );
    }
    ...
    private ClientEntity overrideClientByApplication( ClientEntity client, Client application ) {
